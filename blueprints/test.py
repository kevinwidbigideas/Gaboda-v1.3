...
QUESTIONS = {
    ...
    4: {
        ...
        "options": [
            {"text": "고수, 오이, 마라 등<br> 기피 음식이 있다", "icon": "restaurant", "input_required": True},
    ...
    15: {
        ...
        "options": [
            {"text": "걱정마! 근처에 비슷한 분위기의<br>별점 높은 곳이 있으니 그리고 가자.", "icon": "lightbulb"},
...
def test():
    ...
    <body class="bg-slate-50 min-h-screen">
        <!-- 인트로 화면 -->
        <div id="intro-overlay" class="fixed inset-0 z-50 bg-white flex flex-col items-center justify-center transition-opacity duration-1000 opacity-100 p-8">
            <div class="text-center space-y-6">
                <h1 id="intro-line-1" class="text-3xl md:text-5xl font-bold text-slate-800 leading-relaxed tracking-wide transition-opacity duration-1000 opacity-0 transform translate-y-4">
                    <span class="text-blue-600">Travis</span>와 1박2일 여행을 통해,
                </h1>
                <h2 id="intro-line-2" class="text-2xl md:text-4xl font-medium text-slate-700 leading-relaxed tracking-wider transition-opacity duration-1000 opacity-0 transform translate-y-4 delay-500">
